...
def generate_student(request):
    if request.method == 'GET':
        ...
        return HttpResponse(f"""New student has been created! ID: {student.id} 
...
def generate_students(request):
    try:
        if request.method == 'GET':
            ...
            return HttpResponse(f"{count} students created! There are {student.id} students in the db.")
        else:
            return HttpResponse("Invalid request method! Please, try again using GET method.")
    except (Exception, ):
        return HttpResponse("Invalid request method! Please, try again using GET method. "
